...
void ProjectPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->on_make_jtmod(); break;
        case 15: _t->on_jtmod_result(); break;
        case 16: _t->on_jtmod_thread_done(); break;
        case 17: _t->on_deploy(); break;
        case 18: _t->on_restore_stock(); break;
        default: ;
        }
    }
}
